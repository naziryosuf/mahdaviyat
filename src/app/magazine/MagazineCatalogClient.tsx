              ...
              return (
                <>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    ...
                    {/* Eitaa */}
                    <a
                      href={`https://eitaa.com/share/url?url=${encodeURIComponent(issueShareUrl)}&text=${encodeURIComponent(`📖 ${sharingIssue.title_fa} - شماره ${sharingIssue.issue_number}`)}`}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <button
                      onClick={() => {
                        ...
                        showToast('لینک مستقیم شماره مجله کپی شد');
                      }}
